  ...
  return (
    <section>
      <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
       ...
       <div className={`${styles.centerDiv} ${styles.relative} ${styles.hFull} ${styles.wFull} ${styles.overflowClip} ${styles.roundedMd} ${styles.border} ${styles.borderZinc200} ${styles.bgWhite} ${styles.p2} ${styles.px0} ${styles.py0}`}>
        <iframe
